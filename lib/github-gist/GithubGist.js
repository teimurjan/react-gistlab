...
exports.getCallbackName = function (_a) {
    var gistID = _a.gistID, filename = _a.filename;
    return "gist_callback_" + gistID + (filename ? "__" + filename.replace(/[^0-9A-z]/g, '') : '');
};
var GithubGist = (function (_super) {
    ...
    function GithubGist(props) {
        ...
        _this.initCallback = function () {
            ...
            window[exports.getCallbackName(info)] = function (data) {
                _this.setState({
                    isLoading: false,
                    data: data
                });
        ...
        _this.addScriptTag = function () {
            ...
            var queryParams = (info.filename ? ["file=" + info.filename] : []).concat([
                "callback=" + exports.getCallbackName(info)
            ]);
